...
exports.getUserWithBankDetails = async (req, res) => {
  ...
  try {
    const rows = await transactionDAO.getUserWithBankDetailsById(
      userId,
      centerId,
      companyId,
    );
...
exports.GetFarmerReportDetails = async (req, res) => {
  ...
  try {
    ...
    const cropDetails = await transactionDAO.GetFarmerReportDetailsDao(
      userId,
      createdAt,
      farmerId,
    );
...
exports.getTransactionHistory = async (req, res) => {
  try {
    ...
    const transactions = await transactionDAO.getTransactionHistoryByUserId(
      userId,
      limit,
      offset,
    );
