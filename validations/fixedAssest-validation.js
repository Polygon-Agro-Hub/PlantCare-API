...
exports.addFixedAssetSchema = Joi.object({
  ...
  durationMonths: Joi.alternatives()
    .try(Joi.number(), Joi.string().allow(""))
    .label("Duration in Months"),
  durationYears: Joi.alternatives()
    .try(Joi.number(), Joi.string().allow(""))
    .label("Duration in Years"),
  estimateValue: Joi.alternatives()
    .try(Joi.number(), Joi.string().allow(""))
    .label("Estimated Value"),
  expireDate: Joi.date().allow(null).label("Expire Date"),
  extentac: Joi.alternatives()
    .try(Joi.number(), Joi.string().allow(""))
    .label("Extent (ac)"),
  extentha: Joi.alternatives()
    .try(Joi.number(), Joi.string().allow(""))
    .label("Extent (ha)"),
  extentp: Joi.alternatives()
    .try(Joi.number(), Joi.string().allow(""))
    .label("Extent (p)"),
  floorArea: Joi.alternatives()
    .try(Joi.number(), Joi.string().allow(""))
    .label("Floor Area"),
  generalCondition: Joi.string().allow("").label("General Condition"),
  issuedDate: Joi.date().allow(null).label("Issued Date"),
  landFenced: Joi.alternatives()
    .try(Joi.boolean(), Joi.string().valid("yes", "no").allow(""))
    .label("Land Fenced"),
  leastAmountAnnually: Joi.alternatives()
    .try(Joi.number(), Joi.string().allow(""))
  ...
  numberOfUnits: Joi.alternatives()
    .try(Joi.number(), Joi.string().allow(""))
    .label("Number of Units"),
  ownership: Joi.string().allow("").label("Ownership"),
  paymentAnnually: Joi.alternatives()
    .try(Joi.number(), Joi.string().allow(""))
    .label("Payment Annually")
    .custom((value, helpers) => {
      return value;
    }),
  perennialCrop: Joi.alternatives()
    .try(Joi.boolean(), Joi.string().valid("yes", "no").allow(""))
    .label("Perennial Crop"),
  permitFeeAnnually: Joi.alternatives()
    .try(Joi.number(), Joi.string().allow(""))
  ...
  warrantystatus: Joi.array()
    .items(
      Joi.object({
        key: Joi.string().allow(""),
        value: Joi.alternatives().try(
          Joi.boolean(),
          Joi.string().valid("yes", "no").allow(""),
        ),
      }),
    )
